...
DROP TABLE IF EXISTS loggedUsers CASCADE;
...
CREATE TABLE if NOT EXISTS guestUsers(id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, email VARCHAR(320) UNIQUE, files_processed SMALLINT NOT NULL, summaries_made SMALLINT NOT NULL);
...
INSERT INTO guestusers (email, files_processed, summaries_made) VALUES ('guest12345678@sightable.ai', 3, 0);
INSERT INTO guestusers (email, files_processed, summaries_made) VALUES ('guest87654321@sightable.ai', 1, 2);
INSERT INTO guestusers (email, files_processed, summaries_made) VALUES ('guest11223344@sightable.ai', 2, 1);
